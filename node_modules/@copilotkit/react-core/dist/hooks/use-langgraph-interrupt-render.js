...
function useLangGraphInterruptRender() {
  ...
  const responseRef = import_react2.default.useRef();
  const resolveInterrupt = (0, import_react2.useCallback)(
    (response) => {
  ...
  const conditionsMet = (0, import_shared.executeConditions)({ conditions, value: event.value });
  if (!conditionsMet) {
    return null;
  }
  let result = null;
  ...
  return import_react2.default.createElement(InterruptRenderer, {
    event,
    result,
    render,
    resolve: resolveInterrupt
